...
We want to avoid this situation, but we don’t want to bear the price of third-party defenses such as behavioral verification codes, nor do we want to spend time and effort to study how to prevent the interface from being abused.
...
## Example
SAC provides examples of front-end JavaScript and examples of commonly used server-side development languages ​​for the back-end.

The front-end example is located in the JavaScript directory of the root directory. The back-end example is as follows. ├─Server
| ├─Ruby
| | └Example.rb
| ├─Python
| | └Example.py
